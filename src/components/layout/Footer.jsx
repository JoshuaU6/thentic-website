        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            <Link to="/" className="flex items-center gap-3 mb-5 group w-fit">
              <div
                className="rounded-full overflow-hidden flex-shrink-0 transition-all duration-300 group-hover:ring-2 group-hover:ring-gold/30"
                style={{ width: 56, height: 56, background: '#fff', padding: 3 }}
              >
                <img
                  src={logo}
                  alt="Thentic Liquor"
