    ...
    <footer className="border-t border-gold/10 mt-0">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            <div className="mb-4">
              <div className="font-cinzel font-bold text-2xl tracking-[0.2em] gold-text">THENTIC</div>
              <div className="font-script italic text-sm text-gold/70 tracking-widest mt-0.5">Liquor</div>
            </div>
            <p className="font-script italic text-gold/60 text-sm leading-relaxed">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              {[['/', 'Home'], ['/products', 'The Mix'], ['/about', 'Our Story'], ['/order', 'Order'], ['/contact', 'Contact']].map(([to, label]) => (
